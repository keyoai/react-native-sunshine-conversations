...
public class ReactNativeSmooch extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void setActiveConversationId(final String conversationId, final Promise promise) {
    ...
    private WritableMap convertMessageToMap(Message message, String conversationId) {
    ...
    private WritableMap convertConversationToMap(Conversation c) {
        ...
        map.putInt("unreadCount", c.getUnreadCount());
        return map;
    }
        ...
        Smooch.getConversationById(conversationId, new SmoochCallback<Conversation>() {
            ...
            public void run(Response<Conversation> response) {
              if (promise != null) {
                ...
                metadata.putAll(globalMetadata.toHashMap());
    ...
    @ReactMethod
    public void getUnreadCount(String conversationId, final Promise promise) {
        Smooch.getConversationById(conversationId, new SmoochCallback<Conversation>() {
            @Override
            public void run(Response<Conversation> response) {
              if (promise != null) {
              ...
              if (promise != null) {
                ...
                for (Message message : messages) {
                    ...
                    if (message != null && metadata != null && metadata.get("author") != null) {
                        WritableMap map = convertMessageToMap(message, conversationId);
    ...
    private void setConversationDelegate() {
        Smooch.setConversationDelegate(new ConversationDelegate() {
            ...
            public void onUnreadCountChanged(@NonNull Conversation conversation, int i) {
                WritableMap result = new WritableNativeMap();
                result.putString("conversationId", conversation.getId());
